...
export class WhatsAppService {
    ...
    /**
     * Handle raw incoming webhook payload from Meta
     */
    async handleIncomingWebhook(payload: WebhookPayload): Promise<void> {
        // For now, we emit an event for the subscriber to handle.
        eventBus.emitDomainEvent(DomainEvent.WHATSAPP_WEBHOOK_RECEIVED, payload);
    }
}
