import { PrismaClient, ReminderStatus, Prisma, RepeatInterval } from '@prisma/client';
...
export class CalendarRepository {
    ...
    async cleanAndRouteEvent(userId: string, externalId: string, data: { title: string; message: string; schedule: Date; repeat: RepeatInterval }, status: ReminderStatus, now: Date) {
        const reminderData = {
            title: data.title,
