...
export class GoogleCalendarProvider {
    ...
    private async executeGoogleCall<T>(call: () => Promise<T>): Promise<T> {
        return await call();
    }
    ...
    async listEvents(auth: ReturnType<typeof this.getClient>, start: Date, end: Date): Promise<calendar_v3.Schema$Events> {
